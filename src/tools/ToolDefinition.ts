...
import {parseArguments} from '../config/mcp-options.js';
import type {
...
export function resolveToolArgs(args?: ParsedArguments): ParsedArguments {
  if (args !== undefined) {
    return args;
  }
...
>(
  ...
  return (args?: Args) => {
    return definition(resolveToolArgs(args) as Args);
  };
}
